...
const Create = () => {
    ...
    let but1 = (e) =>{
        e.preventDefault()
        axios.post('http://localhost:3000/create',{first_name,last_name,email,gender,avatar,domain,available})
        .then(()=>{
                ...
                <Card sx={{ maxWidth: '80%', margin: 'auto' }}>
                    <CardContent component='form'>
                        <Box component="form" noValidate sx={{ mt: 3 }}>
                            <Typography variant='h4' sx={{mb:'2vh'}}>Create Employee</Typography>
